...
int menuDeOpciones()
{
	...
	if(getIntRange(&opcion, 1, 11, 3, "Ingrese un numero entre las opciones: ", "Dato incorrecto. Ingrese un numero entre el 1 y el 11 segun las opciones: ") == -1) //Si no puede tomarla devolvera una opcion que ira al default
	{
		opcion = 200;
	}
